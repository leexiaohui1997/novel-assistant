...
-- 创建索引以提高按小说查询性能
CREATE INDEX IF NOT EXISTS idx_chapter_term_relations_novel_id ON chapter_term_relations(novel_id);
...
-- 创建复合索引以优化按小说 + 章节组合查询
CREATE INDEX IF NOT EXISTS idx_chapter_term_relations_novel_chapter ON chapter_term_relations(novel_id, chapter_id);
